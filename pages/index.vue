...
<template>
  <div>
    ...
    <section class="py-7">
      <div class="container mx-auto px-3 grid gap-14 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 justify-center justify-items-center text-center">
